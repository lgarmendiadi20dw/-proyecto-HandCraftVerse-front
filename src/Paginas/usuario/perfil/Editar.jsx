  ...
  return (
    <form onSubmit={enviarFormulario} className="row">
      ...
      <div className="userInfo col-8">
        ...
        <Text type="text" text="Teléfono" value={user.telefono === 0 ? null : user.telefono}  />
        <Text type="text" text="Dirección" value={user.direccion}  />
        <TextArea text="Descripción" value={user.descripcion} />
