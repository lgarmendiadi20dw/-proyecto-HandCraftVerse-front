...
const Editar = ({ producto, setProducto, apiIp }) => {
  ...
  const enviarFormulario = async (event) => {
    ...
    try {
      const response = await fetch(`${apiIp}productos/update/${producto.id}`, {
        method: "PUT",
        headers: {
      ...
      setProducto(result); // Actualizar el producto con los datos nuevos
      document.getElementById("mensaje").innerText = "Producto actualizado exitosamente";
    } catch (error) {
      document.getElementById("mensaje").innerText = "Error al actualizar el producto";
    ...
    <div className="container tw-mt-6 tw-flex tw-justify-center tw-items-center">
      <div className="row col-12">
        <div className="formulario">
          <h1 className="textoTitulo">Editar Producto</h1>
...
<div className="row">
    <div className="col-10"><Button text="Actualizar" type="submit" /></div>
    <div className="col-2"><Button  // Alterna el valor de editMode
  className= {"danger"}  // Aplica la clase 'danger' si editMode es true
  text={ 
    "Cancelar" 
  } 
/></div>
